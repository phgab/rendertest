    ...
    convHandlerCron = ConversationHandler(
        ...
        states={
            ...
            SCH_WDAYS: [CallbackQueryHandler(selectWDays),
                        MessageHandler(filters.TEXT & (not filters.COMMAND), readAddress_selectWDays)],
            SCH_HOURS: [CallbackQueryHandler(enterHours, pattern='^(?!.*' + str(MANUAL_SEL) + ').*$'),
                        CallbackQueryHandler(enterWDays, pattern='^' + str(MANUAL_SEL) + '$'),
                        MessageHandler(filters.TEXT & (not filters.COMMAND), readWDays_enterHours)],
            ...
            TITLE: [CallbackQueryHandler(enterTitle, pattern='^(?!.*' + str(MANUAL_SEL) + ').*$'),
                    ...
                    MessageHandler(filters.TEXT & (not filters.COMMAND), readMin_enterTitle)],
            CONFIRM: [MessageHandler(filters.TEXT & (not filters.COMMAND), confirmJob)],
